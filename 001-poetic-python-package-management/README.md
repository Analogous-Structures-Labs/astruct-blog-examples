...
```text 001-poetic-python-package-management/pipapp/requirements/requirements.txt
```

Dev requirements:
```text 001-poetic-python-package-management/pipapp/requirements/requirements.dev.txt
```
